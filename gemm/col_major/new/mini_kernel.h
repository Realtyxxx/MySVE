...
void vl_8(int m, int k, float* alpha, float* a, float* b, float* beta, float* c,
  ...
  if (*beta != 0) {
    ...
    z2 = svld1(pg0, c_ptr + m);
    z3 = svld1(pg1, c_ptr + m + vl);

    z4 = svld1(pg0, c_ptr + m_2);
    z5 = svld1(pg1, c_ptr + m_2 + vl);

    z6 = svld1(pg0, c_ptr + m_3);
    z7 = svld1(pg1, c_ptr + m_3 + vl);
  ...
  svst1_f32(pg0, c_ptr + m, z2);
  svst1_f32(pg1, c_ptr + m + vl, z3);

  svst1_f32(pg0, c_ptr + m_2, z4);
  svst1_f32(pg1, c_ptr + m_2 + vl, z5);

  svst1_f32(pg0, c_ptr + m_3, z6);
  svst1_f32(pg1, c_ptr + m_3 + vl, z6);
