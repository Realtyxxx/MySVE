...
# 272 "/usr/include/aarch64-linux-gnu/bits/mathcalls.h" 3 4
...
# 290 "/usr/include/aarch64-linux-gnu/bits/mathcalls.h" 3 4
...
# 396 "/usr/include/aarch64-linux-gnu/bits/mathcalls.h" 3 4
...
# 1 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/stddef.h" 1 3 4
# 209 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/stddef.h" 3 4
...
# 14 "gemm.h" 2
# 1 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/stdbool.h" 1 3 4
# 15 "gemm.h" 2
...
# 1 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/stdarg.h" 1 3 4
# 40 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/stdarg.h" 3 4
...
# 1 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/stddef.h" 1 3 4
# 321 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/stddef.h" 3 4
...
# 177 "/usr/include/aarch64-linux-gnu/sys/types.h" 3 4
...
# 193 "/usr/include/aarch64-linux-gnu/sys/types.h" 3 4
...
# 194 "/usr/include/aarch64-linux-gnu/sys/types.h" 2 3 4
...
# 197 "/usr/include/aarch64-linux-gnu/sys/types.h" 2 3 4
...
# 244 "/usr/include/aarch64-linux-gnu/sys/types.h" 3 4
...
# 245 "/usr/include/aarch64-linux-gnu/sys/types.h" 2 3 4
...
void my_dgemm_Macro(const int M, const int N, const int K,
                     ...
                     MATRIX_TYPE c, const int ldc);
# 2 "gemm.c" 2
# 1 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/omp.h" 1 3 4
# 41 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/omp.h" 3 4
...
# 188 "/usr/local/gcc-11.1.0/lib/gcc/aarch64-unknown-linux-gnu/11.1.0/include/omp.h" 3 4
...

{
  ...
  for (j = 0; j < N; j += 8) {
    for (i = 0; i < M; i += 128) {
      ...
      sgemm_armv8a_sve_asm_2vx8(K, &alpha, &packA[i * K], &packB[j * K], &beta, &c[(j)*ldc + (i)], 1, ldc, a_next, b_next);
    }
  }
}
...

{
  ...
  packA = malloc_aligned(256, (256 + 1) * total_threads, sizeof(float));

  packB = malloc_aligned(256, (32 + 1), sizeof(float));
...
#pragma omp parallel for num_threads(total_threads) private(j)
      ...
      for (j = 0; j < jb; j += 8) {
        packB_kcxnc_d(((jb - j) < (8) ? (jb - j) : (8)), pb, &b[pc], K, jc + j, &packB[j * pb]);
      }


#pragma omp parallel for num_threads(total_threads) private(ic, ib, i)

      for (ic = 0; ic < M; ic += 256) {

        int tid = omp_get_thread_num();



        ib = ((M - ic) < (256) ? (M - ic) : (256));

        for (i = 0; i < ib; i += 128) {
          packA_mcxkc_d(((ib - i) < (128) ? (ib - i) : (128)), pb, &a[pc * lda], M, ic + i, &packA[tid * 256 * pb + i * pb]);
        }
        sgemm_Macro(ib, jb, pb, alpha, packA + tid * 256 * pb, lda, packB, ldb, _beta, &c[(jc)*ldc + (ic)], ldc);
      }
    }
  }
  free(packA);
