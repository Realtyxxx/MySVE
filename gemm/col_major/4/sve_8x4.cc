 ...
 * @LastEditTime : 2022-01-16 16:35:18
 * @FilePath     : /sve/sve_gemm/sve_8x4.c
 * @ToDo         :
 */
#include "gemm.h"

// @msg: in register computation C (mr(4) * nr(4)) + A (mr * kc) * B (kc  * nr) * alpha + beta * C; * @param {int} k
void add_dot_8x4_sve(int k, MATRIX_TYPE restrict a, int lda, MATRIX_TYPE restrict b, int ldb, VALUE_PTR restrict alpha, MATRIX_TYPE restrict c, int ldc, VALUE_PTR restrict beta) {
  /*
   ...
   *
   *    c_00_c_10_c_20_c_30_c_40_c_50_c_60_c_70 += a_0p_a_1p_a_2p_a_3p_a_4p_a_5p_a_6p_a_7p * b_p0_b_p0_b_p0_b_p0_b_p0_b_p0_b_p0_b_p0;
   *    c_01_c_11_c_21_c_31_c_41_c_51_c_61_c_71 += a_0p_a_1p_a_2p_a_3p_a_4p_a_5p_a_6p_a_7p * b_p1_b_p1_b_p1_b_p1_b_p1_b_p1_b_p1_b_p1;
   *    c_02_c_12_c_22_c_32_c_42_c_52_c_62_c_72 += a_0p_a_1p_a_2p_a_3p_a_4p_a_5p_a_6p_a_7p * b_p2_b_p2_b_p2_b_p2_b_p2_b_p2_b_p2_b_p2;
   *    c_03_c_13_c_23_c_33_c_43_c_53_c_63_c_73 += a_0p_a_1p_a_2p_a_3p_a_4p_a_5p_a_6p_a_7p * b_p3_b_p3_b_p3_b_p3_b_p3_b_p3_b_p3_b_p3;
   *
   *    } */

  /* 8 times unrolled */
  uint64_t k_iter = k / 8; /* need load */
  uint64_t k_left = k % 8;
