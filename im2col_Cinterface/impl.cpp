 ...
 */
void im2col(float *src, float *dst, const int stride, const int pad, const int channel, const int height,
            const int width, const int kernel_height, const int kernel_width, const int out_height,
            const int out_width) {
...
void conv_im2col_gemm_f32(float *src, float *weights, float *dst, int batches, int channel, int height, int width,
  ...
  float *trans_image = new float[(out_height * out_width * channel * kernel_height * kernel_width)];
